...
use crate::vcard::property::types::PROPERTY_TYPE_HOBBY;
use crate::vcard::values::data::ValueData;
use crate::vcard::values::kind::ValueKind;
use crate::VcardError;

pub fn hobby_get_value(str: &str, kind: &Option<ValueKind>) -> Result<ValueData, VcardError> {
...
pub fn hobby_allowed_parameter(parameter_type: &ParameterType) -> Result<(), VcardError> {
    match parameter_type {
        ...
        _ => Err(VcardError::ParameterTypeNotAllowed(parameter_type.to_string(), String::from(PROPERTY_TYPE_HOBBY))),
    }
}
