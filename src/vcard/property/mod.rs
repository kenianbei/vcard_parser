...
/// Normally you won't create this manually, rather you would use the Vcard implementations for [adding](super::Vcard::add_property)
/// and [updating](super::Vcard::update_property) the property instead, as properties are immutable.
///
/// # Examples
/// ```
